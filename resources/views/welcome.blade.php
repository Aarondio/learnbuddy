        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
            <div class="text-center">
                <h1
                    ...
                    <span class="block text-indigo-600 dark:text-indigo-400">for Students</span>
                </h1>
                <p
                ...
                <div class="mt-8 flex flex-col sm:flex-row justify-center gap-4">
                    ...
                    @else
                        ...
                        <a href="#features"
                            class="flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 dark:text-indigo-100 dark:bg-indigo-900/50 dark:hover:bg-indigo-800/50 md:py-4 md:text-lg md:px-10">
                            Learn More
                        </a>
                    @endauth
                </div>
    ...
    <footer class="bg-white dark:bg-gray-900">
        <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
            <p class="mt-8 text-center text-base text-gray-500 dark:text-gray-400">
                &copy; {{ date('Y') }} Student Buddy. All rights reserved.
            </p>
        </div>
    </footer>
